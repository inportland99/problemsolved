this.crackcode = this.crackcode || {},
this.crackcode.bundle = function(e) {
    "use strict";
    function a(e) {
    ...
    z.innerHTML = "\n  <slot></slot>\n";
    var j = "crackthecode-darkmode"
      , S = "crackthecode-cbmode"
      , C = function(e) {
        r(t, e);
        var a = h(t);
        function t() {
    ...
    var Ma = ["12345","23456","34567","45678","00000"]
      , Oa = ["11111","22222","33333","44444"]
      , Ra = "present"
      , Ha = "correct"
      , Na = "absent";
    var Pa = {
    ...
    var Ga = new Date(2021,1,1,0,0,0,0);
    function Ba(e, a) {
        var s = new Date(e)
    ...
    function Va(e) {
        ...
        return a = s % Ma.length, secret_code;
    }
    ...
    // var Ka, Qa = "crackthecode-refresh", es = window.localStorage;
    // function as() {
    ...
    //     ), 432e5))
    // }
    // var ss = "crackthecode-statistics"
      ...
      , ms = function(e) {
        ...
        return n(t, [{
            ...
            value: function() {
                if (this.gameStatus === ls && this.canInput) {
                    if (5 !== this.tileIndex)
                        ...
                        void this.addToast("Not enough digits");
                    this.evaluateRow()
                }
            }
        }, {
            ...
            value: function() {
                ...
                this.shadowRoot.getElementById("practice-button").addEventListener("click", (function(e) {
                  // show/hide practice mode label somewhere
                  var practicemode = window.localStorage.getItem("crackthecode-practicemode")
                  if (practicemode == 'true') {
                    window.localStorage.setItem("crackthecode-practicemode", 'false');
                    // hide a play again button
                  }
                  else {
                    window.localStorage.setItem("crackthecode-practicemode", 'true');
  ...
  ***************************************************************************** */
    ...
    Qs.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Guess the <strong>SECRET CODE</strong> in six tries.</p>\n      <p>Each guess must be a five-digit number. Hit the enter button to submit.</p>\n      <p>After each guess, the color of the tiles will change to show how close your guess was to the secret code.</p>\n      <div class="examples">\n        <p><strong>Examples</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="1" evaluation="correct" reveal></game-tile>\n            <game-tile letter="2"></game-tile>\n            <game-tile letter="3"></game-tile>\n            <game-tile letter="4"></game-tile>\n            <game-tile letter="5"></game-tile>\n          </div>\n          <p>The digit <strong>1</strong> is in the word and in the correct spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="5"></game-tile>\n            <game-tile letter="7" evaluation="present" reveal></game-tile>\n            <game-tile letter="3"></game-tile>\n            <game-tile letter="3"></game-tile>\n            <game-tile letter="1"></game-tile>\n          </div>\n          <p>The digit <strong>7</strong> is in the word but in the wrong spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="9"></game-tile>\n            <game-tile letter="8"></game-tile>\n            <game-tile letter="2"></game-tile>\n            <game-tile letter="6" evaluation="absent" reveal></game-tile>\n            <game-tile letter="0"></game-tile>\n          </div>\n          <p>The digit <strong>6</strong> is not in the word in any spot.</p>\n        </div>\n      </div>\n      <p><strong>A new SECRET CODE will be available each day!<strong></p>\n    </div>\n  </section>\n';
    var et = function(e) {
        r(t, e);
        var a = h(t);
        function t() {
    ...
    var nt = {
        ...
        practice: "M.64,19.71l1.1-5.44L15.42,.72l3.97,4.41L6.14,18.72l-5.5,.99ZM12.55,3.65l4.3,4.3M2.23,14.35l4.15,4.11",
